...
The repository's no-non-ascii pre-commit hook rejects any byte above 0x7F in the source
and doc types below, so an accidental Cyrillic letter or a typographic dash otherwise
...
CHECKED_SUFFIXES = {".mc", ".yml", ".yaml", ".md", ".json", ".xml", ".jungle", ".toml"}
